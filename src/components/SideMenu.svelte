<script lang="ts">
  ...
  import type {PageData} from '../routes/intern/$types'

  export let data: PageData
  export let role: string
  export let showMenu: boolean
  export let tabSwitch: boolean
